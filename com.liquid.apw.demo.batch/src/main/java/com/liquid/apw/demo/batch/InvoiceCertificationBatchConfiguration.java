 ...
 * 
 */
package com.liquid.apw.demo.batch;
...
import com.liquid.apw.demo.batch.listener.InvoiceCertificationChunkCompletionNotificationListener;
import com.liquid.apw.demo.batch.listener.InvoiceCertificationItemWriterListener;
import com.liquid.apw.demo.batch.listener.InvoiceCertificationJobCompletionNotificationListener;
import com.liquid.apw.demo.domain.InvoiceCertificationDomainService;
...
public class InvoiceCertificationBatchConfiguration {
	...
	public MyBatisPagingItemReader<SupplierInvoice> makeReader(){
    	...
    	reader.setQueryId("com.liquid.apw.demo.batch.orm.dao.SupplierInvoiceMapper.selectByCondition");
...
//    	reader.setParameterValues(parameterValues);
	...
	public MyBatisBatchItemWriter<InvoiceCertification> makeWriter(){
		...
		writer.setStatementId("com.liquid.apw.demo.batch.orm.dao.InvoiceCertificationMapper.insert");
		return writer;
	}
}
